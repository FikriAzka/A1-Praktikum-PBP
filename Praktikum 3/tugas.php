...
<body>
    ...
    <form method="post">
        ...
        <label for="nama">NIS:</label><br />
            <input type="text" class="form-control"  id="nis" name="nis" maxlength="10" required value="<?php if(isset($nis)) {echo $nis;} ?>">
            <div class="error"><?php if(isset($error_nis)) echo $error_nis;?></div>
        </div>
        <div class = "form-group m-2">
        <label for="nama">Nama:</label><br />
            <input type="text" class="form-control" id="nama" name="nama"  required value="<?php if(isset($nama)) {echo $nama;} ?>">
        ...
        <div class="form-group m-2">
            ...
            <select name="kelas" id="kelas" class="form-control" onchange="toggleEkstrakurikuler()" required>
